...
using BankAppForm.BankAppCustomerService;
using BankAppForm.BankAppTransactionService;
...
namespace BankAppForm
{
    public partial class Form1 : Form
    {
        ...
        private void btn_makeTransaction_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    !txt_TransactionAmount.Text.ToCharArray().Any(x => Char.IsLetter(x)))
                {
                    ...
                    {
                        success = transactionSoapClient.Transfer(senderCustomer.CustomerID, recieverCustomer.CustomerID, decimal.Parse(txt_TransactionAmount.Text));
                    }
                }
        ...
        private void txt_Reciever_ID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                recieverCustomer = SelectCustomerByID(int.Parse(txt_Reciever_ID.Text));
